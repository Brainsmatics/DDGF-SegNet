...
def trainValidateSegmentation(args):
    ...
    # load the model
    model = net.UNet(3 ,args.classes)#下次用1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default=r'G:\zhanghong\dataall-train\dataset-brain', help='Data directory')
    ...
    parser.add_argument('--scaleIn', type=int, default=1, help='Its OK')
    parser.add_argument('--max_epochs', type=int, default=240, help='Max. number of epochs')
    ...
    parser.add_argument('--savedir', default=r'G:\zhanghong\dataall-train\brainmodel', help='directory to save the results')
    ...
    parser.add_argument('--cached_data_file', default='brain.p', help='Cached file name')
    parser.add_argument('--logFile', default='brain-trainValLog.txt', help='File that stores the training and validation logs')
    ...
    #parser.add_argument('--pretrained', default='../pretrained/encoder/espnet_p_2_q_2.pth', help='Pretrained ESPNet-C weights. '
