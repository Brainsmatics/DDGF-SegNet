...
class U_AdaptiveReceptiveField(nn.Module):
    ...
    def __init__(self, classes=20):
        ...
        '''
        super().__init__()
        self.level1 = CBR(3, 64, 3, 1)
        self.level1_ARF = Full_AdaptiveReceptiveField(64, 64)
        self.dsample1 = InputProjectionA(1)

        self.level2 = CBR(64 + 3, 128, 3, 1)
        self.level2_ARF = Full_AdaptiveReceptiveField(128, 128)
        self.b2 = BR(64 + 3)
        #self.br2 = nn.BatchNorm2d(28, eps=1e-03)
        self.dsample2 = InputProjectionA(1)

        self.level3 = CBR(128 + 67, 256, 3, 1)
        self.level3_ARF = AdaptiveReceptiveField(256, 256)
        self.b3 = BR(195)
        #self.br3 = nn.BatchNorm2d(50+28, eps=1e-03)
        self.dsample3 = InputProjectionA(1)

        self.level4 = CBR(256+128+67, 512, 3, 1)
        self.level4_2 = CBR(512, 512, 3, 1)
        self.b4 = BR(451)

        #解码
        self.upsample4 = nn.ConvTranspose2d(512, 512, 2, stride=2, padding=0, output_padding=0, bias=False)

        self.b33 = BR(256+512)
        self.level3_o = CBR(256+512, 256, 3, 1)
        self.level3_o2 = CBR(256, 256, 3, 1)
        self.upsample3 = nn.ConvTranspose2d(256, 256, 2, stride=2, padding=0, output_padding=0, bias=False)

        self.b22 = BR(28+256)
        self.level2_o = CBR(28+256, 128, 3, 1)
        self.level2_o2 = CBR(128, 128, 3, 1)
        self.upsample2 = nn.ConvTranspose2d(128, 128, 2, stride=2, padding=0, output_padding=0, bias=False)

        self.b11 = BR(16+128)
        self.level1_o = CBR(16+128, 64, 3, 1)
        self.classifier = C(64, classes, 1, 1)
