...
def evaluateModel(args, image_list):
    ...
    for i, imgName in enumerate(image_list):
        ...
        name = imgName.split('/')[-1]
        cv2.imwrite(args.savedir + os.sep + 'gray_' + name.replace(args.img_extn, 'png'), otsu)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inWidth', type=int, default=1024, help='Width of RGB image')#程序里压根没用？
    parser.add_argument('--inHeight', type=int, default=2048, help='Height of RGB image')
